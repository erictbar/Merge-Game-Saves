...
powershell.exe -ExecutionPolicy Bypass -File "C:\Users\erict\OneDrive\Developer\Scripts\Public\Merge Game Saves\WinToADB.ps1" -UseLatest -AutoConnect -InitialWait 15 -MaxRetries 5 -RetryDelay 3 -ShowDetails -RemotePath '/sdcard/Android/data/com.crunchyroll.gv.blacklilystale.game/files/Savedata'
